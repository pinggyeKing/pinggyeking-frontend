...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center pt-[35px] pb-[140px] md:pb-[20px] min-h-screen">
      {/* 로고 타이틀 */}
      <div className="text-extra-title text-grey-8 text-center leading-[68px] mb-[24px]">
        변명연구소
      </div>

      {/* 메인 카드 */}
      <div className="w-full px-6 flex justify-center items-center">
        <div className="w-full radius-24 flex flex-col justify-center items-center border-2 border-grey-7 bg-grey-0 py-8 px-5 mb-7">
          {/* 상단 텍스트 */}
          ...
          {/* 캐릭터 이미지 */}
          <div className="w-full h-[164px] flex justify-center items-center mb-4">
            <Image
          ...
          {/* 버튼 */}
          <div className="w-full max-h-[48px] flex justify-between gap-4">
            <CustomButton round="square" className="whitespace-nowrap">
              <Link href="/create">핑계 만들기</Link>
            </CustomButton>
            <CustomButton round="square" typeStyle="outline2">
              <Link href="/gallery" className="whitespace-nowrap">
                핑계 갤러리
              </Link>
            </CustomButton>
          </div>
